...
export const jobs = mysqlTable("jobs", {
  ...
  emailShares: int("emailShares").default(0).notNull(),
  linkedinShares: int("linkedinShares").default(0).notNull(),
  twitterShares: int("twitterShares").default(0).notNull(),
  facebookShares: int("facebookShares").default(0).notNull(),
  whatsappShares: int("whatsappShares").default(0).notNull(),
  linkCopies: int("linkCopies").default(0).notNull(),
  createdAt: timestamp("createdAt").defaultNow().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
