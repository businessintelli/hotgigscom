    ...
    try {
      ...
      return {
        ...
        topRecruiters: topRecruiters.map((r: any) => ({
          ...
          jobsAssigned: r.metrics.jobsPosted || 0,
          placements: r.metrics.placements || 0,
          interviewsScheduled: r.metrics.interviews || 0,
        })),
      ...
      return {
        ...
        placementRate: 0,
        avgTimeToHire: 0,
        linkedinCreditsRemaining: 0,
        linkedinCreditsUsed: 0,
        activeCampaigns: 0,
        campaignResponseRate: 0,
        linkedinConnected: false,
        linkedinAccountName: '',
        linkedinCampaignsActive: 0,
...
Provide data-driven, actionable insights based on the company's recruitment operations.`;
  ...
  // Report procedures (stubs - to be fully implemented)
  getRecruitmentOverview: companyAdminProcedure
    .input(z.object({
      dateRange: z.number().default(30),
    }))
    .query(async ({ ctx }) => {
  ...
  getTotalSubmissionsReport: companyAdminProcedure
    .input(z.object({
  ...
  getPlacementsReport: companyAdminProcedure
    .input(z.object({
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }))
  ...
  getSubmissionsByJobReport: companyAdminProcedure
    .input(z.object({
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }))
  ...
  getBackedOutReport: companyAdminProcedure
    .input(z.object({
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }))
  ...
  getFeedbackReport: companyAdminProcedure
    .input(z.object({
      startDate: z.string().optional(),
      endDate: z.string().optional(),
    }))
