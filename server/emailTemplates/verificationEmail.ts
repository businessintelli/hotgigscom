export function getVerificationEmailTemplate(verificationLink: string, userName: string, appTitle: string = "HotGigs"): string {
  return `
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Verify Your Email - ${appTitle}</title>
</head>
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin: 0 0 20px 0;">
                Thank you for signing up for <strong>${appTitle}</strong>! We're excited to have you on board.
              </p>
              ...
              <p style="color: #a0aec0; font-size: 13px; line-height: 1.6; margin: 30px 0 0 0; font-style: italic;">
